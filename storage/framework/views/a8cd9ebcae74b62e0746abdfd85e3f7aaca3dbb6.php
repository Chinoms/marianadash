...
<head>
  ...
  <title>Laratrust - <?php echo $__env->yieldContent('title'); ?></title>
  <link href="<?php echo e(mix('laratrust.css', 'vendor/laratrust')); ?>" rel="stylesheet">
...
<div>
        ...
        <div class="flex items-center">
          <div class="hidden md:block">
            <div class="flex items-baseline">
              <a href="<?php echo e(config('laratrust.panel.go_back_route')); ?>" class="nav-button">← Go Back</a>
              <a
                href="<?php echo e(route('laratrust.roles-assignment.index')); ?>"
                class="ml-4 <?php echo e(request()->is('*roles-assigment*') ? 'nav-button-active' : 'nav-button'); ?>"
              >
                Roles & Permissions Assignment
              </a>
              <a
                href="<?php echo e(route('laratrust.roles.index')); ?>"
                class="ml-4 <?php echo e(request()->is('*roles') ? 'nav-button-active' : 'nav-button'); ?>"
              >
                Roles
              </a>
              <a
                href="<?php echo e(route('laratrust.permissions.index')); ?>"
                class="ml-4 <?php echo e(request()->is('*permissions*') ? 'nav-button-active' : 'nav-button'); ?>"
              >
                Permissions
              </a>
            </div>
  ...
  <main>
    <div class="max-w-6xl mx-auto py-6 sm:px-6 lg:px-8">
      <?php $__currentLoopData = ['error', 'warning', 'success']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if(Session::has('laratrust-' . $msg)): ?>
        <div class="alert-<?php echo e($msg); ?>" role="alert">
          <p><?php echo e(Session::get('laratrust-' . $msg)); ?></p>
        </div>
        <?php endif; ?>
...
</html><?php /**PATH /Applications/MAMP/htdocs/marianadash/resources/views/vendor/laratrust/panel/layout.blade.php ENDPATH**/ ?>