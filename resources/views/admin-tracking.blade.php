...
<div class="col-md-10 offset-md-1 rounded" style="margin-top: -100px;  background-color: white">
    ...
    <div class="container">
        ...
        <ol class="activity-feed mt-4">

            @foreach($tracking as $track)
            
            <li class="feed-item feed-item-secondary">
               <time class="date"> {{ \Carbon\Carbon::parse($track->created_at) }}</time>
                <span class="text">Status <a href="#">{{ $track->status_name }}</a></span><br>
                <span class="text">Location <a href="#">{{ $track->location }}</a></span>
            </li>
